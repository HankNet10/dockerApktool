...
java -jar /usr/local/apktool_2.9.3.jar d /app/down/lanmei_apk/lmbaiyu02.apk -o lanmei
...
apksigner sign --ks /app/down/nosign/$dateTime.jks --ks-key-alias /app/down/nosign/lanmeiCA --ks-pass pass:123456 --out /app/down/lanmei_apk/lmbaiyu02.apk /app/down/nosign/lanmei.no.apk

rm -f /app/down/lanmei_apk/lmbaiyu02.apk.idsig
