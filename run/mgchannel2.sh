...
java -jar /usr/local/apktool_2.9.3.jar d /app/down/mogu_apk/mgchannel2.apk -o mogu
...
apksigner sign --ks /app/down/nosign/$dateTime.jks --ks-key-alias /app/down/nosign/moguCA --ks-pass pass:123456 --out /app/down/mogu_apk/mgchannel2.apk /app/down/nosign/mogu.no.apk

rm -f /app/down/mogu_apk/mgchannel2.apk.idsig
